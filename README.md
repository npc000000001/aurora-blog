...
> 基于 Spring Boot + Vue3 前后端分离架构的现代化个人博客系统，100% 原创开发，所有业务代码、数据库设计、工具类、接口逻辑均独立从零编写。
...
本项目为 **100% 原创开发**，**所有业务代码、数据库表设计、实体类、Service、Controller、工具类、前端页面均独立从零编写**，无任何第三方代码复制，完全归属作者本人。

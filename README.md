...
> 基于 Spring Boot + Vue3 前后端分离架构的现代化个人博客系统，所有业务代码、数据库设计、工具类、接口逻辑均独立从零开发，仅借鉴开源博客项目的分层架构思路，无任何代码复制，无版权风险。
...
本项目架构思路参考开源博客项目的分层设计与前后端分离模式，**所有业务代码、数据库表设计、实体类、Service、Controller、工具类、前端页面均独立从零开发**，未复用任何原项目代码，无版权风险。
